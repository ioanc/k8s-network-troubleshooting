...
CHUNK="60"
TIMEOUT="300"
kubectl debug node/$NODE --image docker.io/alpine:3.18.2 -- sh -xc "chroot /host timeout 300 tcpdump -Z root -i any -G $CHUNK -w $NODE-%M.pcap 'tcp[tcpflags] & (tcp-syn) == (tcp-syn)' ; sleep inf"
