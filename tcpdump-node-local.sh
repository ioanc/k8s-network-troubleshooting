...
CHUNK="300"
kubectl debug node/$NODE --image mcr.microsoft.com/azurelinux/busybox:1.36 -- sh -xc "chroot /host timeout $TIMEOUT tcpdump -Z root -i any -s 256 -G $CHUNK -w $NODE-%I-%M.pcap 'host 1.2.3.4' ; sleep inf"
