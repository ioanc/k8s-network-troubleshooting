...
CHUNK="60"
TIMEOUT="300"
kubectl debug node/$NODE --image mcr.microsoft.com/mirror/docker/library/busybox:1.35 -- sh -xc "chroot /host timeout $TIMEOUT tcpdump -Z root -i any -G $CHUNK -w $NODE-%M.pcap 'host 1.2.3.4' ; sleep inf"
